...
public class Grille {
    ...
    public static char [][] rotationDroit(char[][]grille){
        char [][]grilleRotation;
        grilleRotation = new char[7][7];
        for(int i =0;i<=6;i++){
            for (int j=0;j<=6;j++){
                grilleRotation[i][j]=grille[6-j][i];
            }
        }
        return grilleRotation;
    }
    public static char [][] rotationGauche (char [][] grille){
        ...
        for (int i=0; i<=6; i++) {
            ...
            for ( int j=0 ; j<=6; j++) {
                ...
                grilleRotation [i][j] = grille [j][6-i];
